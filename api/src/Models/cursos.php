...
class Cursos
{
    ...
    {
        return ConexionPDO::query("SELECT id, nombre_curso, nivel, paralelo FROM CURSOS ORDER BY id DESC");
    }

    public static function find($id)
    {
        $sql = "SELECT id, nombre_curso, nivel, paralelo FROM CURSOS WHERE id=:id";
    ...
    public static function add($data)
    {
        ...
        $sql = "INSERT INTO CURSOS (" . implode(',', $campos) . ") VALUES (" . implode(',', $placeholders) . ")";
