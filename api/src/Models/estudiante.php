...
class Estudiantes
{
    ...
    {
        return ConexionPDO::query("SELECT id, nombre, apellido, direccion, telefono FROM ESTUDIANTES ORDER BY id DESC");
    }

    public static function find($id)
    {
        $sql = "SELECT id, nombre, apellido, direccion, telefono FROM ESTUDIANTES WHERE id=:id";
    ...
    public static function update($id, $data)
    {
        ...
        $sql = "UPDATE ESTUDIANTES SET " . implode(',', $campos) . " WHERE id=:id";
        $valores[':id'] = (int) $id;
    ...
    public static function add($data)
    {
        ...
        $sql = "INSERT INTO ESTUDIANTES (" . implode(',', $campos) . ") VALUES (" . implode(',', $placeholders) . ")";
